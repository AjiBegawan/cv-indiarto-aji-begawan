...
const EducationsSection = () => {
  return (
    <section id="educations" className="h-full  mb-10">
      ...
      <div className="grid grid-rows-1 md:grid-cols-2 gap-5 px-10">
            ...
            <div key={education.id}>
              <div>
                <span className="flex justify-center gap-2">
                  ...
                  <h1 className="font-bold text-lg ">{education.schoolName}</h1>
                </span>
